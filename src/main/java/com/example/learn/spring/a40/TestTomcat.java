package com.example.learn.spring.a40;
...
public class TestTomcat {
    ...
    public static void main(String[] args) throws LifecycleException, IOException {
        ...
        // 4.编程添加 Servlet
        // 准确地说是添加初始化器，会在tomcat.start()回调初始化器onStartup()方法，该方法负责添加Servlet
        context.addServletContainerInitializer(new ServletContainerInitializer() {
            ...
            public void onStartup(Set<Class<?>> c, ServletContext ctx) throws ServletException {
                ...
                // 添加容器中的DispatcherServlet方式1
//                DispatcherServlet dispatcherServlet = springContext.getBean(DispatcherServlet.class);
//                ctx.addServlet("dispatcherServlet", dispatcherServlet).addMapping("/");

                // 添加容器中的DispatcherServlet方式2：通过DispatcherServletRegistrationBean
        ...
        /*
           在spring-boot源码的refresh()方法中：onRefresh()执行了上面的1、2、3、4步，finishRefresh()执行了5、6步
         */
    }
...
//        AnnotationConfigServletWebServerApplicationContext
    ...
    static class Config {
        ...
        // 默认的RequestMappingHandlerAdapter没有Jackson消息处理器，所以需要在此处配置
        @Bean
