package com.example.learn.spring.a29;
...
public class A29 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        handlerMethod.setDataBinderFactory(new ServletRequestDataBinderFactory(Collections.emptyList(), null));  // 数据类型转换
        ...
        handlerMethod.setHandlerMethodReturnValueHandlers(getReturnValueHandlers(context));  // 返回值解析器
