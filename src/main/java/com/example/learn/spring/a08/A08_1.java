...
import com.example.learn.spring.a08.sub.E;
 ...
 */
@ComponentScan("com.example.learn.spring.a08.sub")
public class A08_1 {
    ...
    public static void main(String[] args) {
        ...
        // 并非原类，而是代理类：class com.example.learn.spring.a08.sub.F1$$EnhancerBySpringCGLIB$$e7dbfcdd
        ...
        /*
            ...
            解决方法：1、注入的地方加@Lazy
                    2、被注入的多例Bean设置proxyMode
                    3、注入对象工厂ObjectFactory<多例Bean>
                    4、直接通过ApplicationContext获取Bean
         */
    }
}
