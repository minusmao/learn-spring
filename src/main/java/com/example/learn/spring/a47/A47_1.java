...
public class A47_1 {
    public static void main(String[] args) throws NoSuchFieldException, NoSuchMethodException {
        ...
        if (dd3.getDependencyType() == Optional.class) {
            dd3.increaseNestingLevel();  // 字面意思：增加一层内嵌；实际作用：从外层跑到内嵌的一层，这样下面的方法就会找到内部一层的类型
            System.out.println("dd3.getDependencyType()结果：" + dd3.getDependencyType());
        ...
        Object proxy = resolver.getLazyResolutionProxyIfNecessary(dd5, "bean1");  // 如果有@Lazy则创建代理返回，没有就创建目标对象返回
