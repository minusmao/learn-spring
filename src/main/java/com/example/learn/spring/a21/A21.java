package com.example.learn.spring.a21;
...
//                System.out.println(v.getClass());
    ...
    private static HttpServletRequest mockRequest() {
        ...
        request.setAttribute(HandlerMapping.URI_TEMPLATE_VARIABLES_ATTRIBUTE, map);  // 这里手动解析并放入path传参的值到request作用域，供参数解析器解析，此步骤应该由HandlerMapping解析
    ...
    static class Controller {
        public void test(
                ...
                @ModelAttribute("abc") User user1,          // name=zhang&age=18   表单参数转换为对象
