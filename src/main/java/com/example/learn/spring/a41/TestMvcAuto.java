    ...
    static class MyImportSelector implements DeferredImportSelector {
        ...
        public String[] selectImports(AnnotationMetadata importingClassMetadata) {
            return new String[]{
                    ...
                    DispatcherServletAutoConfiguration.class.getName(),  // 配置DispatcherServlet和其注册bean
                    WebMvcAutoConfiguration.class.getName(),  // 配置DispatcherServlet所需组件，处理器、映射器
                    ErrorMvcAutoConfiguration.class.getName()  // BasicErrorController
            };
        }
    }
}
