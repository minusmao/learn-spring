...
public class A24 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        handlerAdapter.afterPropertiesSet();  // 内部执行了解析@ControllerAdvice
        ...
        showBindMethods(handlerAdapter);  // 发现解析了Controller1里的@InitBinder
        ...
        showBindMethods(handlerAdapter);  // 发现解析了Controller2里的@InitBinder
