package com.example.learn.spring.a06;
    ...
    public static void main(String[] args) {
        ...
        /*
            例2: Java 配置类在添加了 bean 工厂后处理器后,
                ...
                原因：refresh方法会先得到beanFactory后处理器，如果在配置类中配置了beanFactory后处理器，则这个配置类会在“容器启动阶段”被提前创建，
                那么它的@Autowired、@PostConstruct就会失效，因为@Autowired、@PostConstruct功能是在“Bean实例化阶段”中，由bean后处理器处理的，
                而它已经提前被创建，所以不会再次经过“Bean实例化阶段”
         */
