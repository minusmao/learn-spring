...
/**
 * spring-boot的run()方法步骤6：绑定 spring.main 到 SpringApplication 对象（*）
 * 前提知识：@ConfigurationProperties的功能实现，通过Binder将env的数据绑定到对象上
 */
public class A39Step6 {
