package com.example.learn.spring.a10;

import com.example.learn.spring.a10.service.MyService;
...
/**
 * 不通过代理类实现AOP方式1-agent类加载：
 *     AspectJ通过在类加载时改变字节码实现AOP（前提：需要运行时配置-javaagent参数）
 */
/*
    注意几点
